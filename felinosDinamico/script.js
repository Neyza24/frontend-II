...
/*<button onclick="modoOscuro()" class="btn-dark">Modo Oscuro</button>*/

//-----------Creando el botón para generar el eventos-------------------------//
const header = document.querySelector('.header');
const btn = document.createElement('button');
const textBtn = document.createTextNode('eventos');
...
const subtitulo = document.querySelectorAll('h2,p');
...
function modoOscuro(){
    ...
    subtitulo.forEach( elemento => elemento.classList.toggle('descripcionOscuro'));
